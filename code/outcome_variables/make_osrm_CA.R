...
#
# It repeats roughly twice the same actions, 
# once for parcels within supply areas of IBS mills only, 
# and once for all UML mills. 
# 
# 
# CATCHMENT AREAS ARE BASED ON TRAVEL TIME BETWEEN PLANTATIONS AND MILLS
#
#
#
### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### 
